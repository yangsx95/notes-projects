package io.github.yangsx95.notes.zip;
...
public class Zip4jUtil {
    ...
    public static String compress(String destFileName, String passwd, File... files) {
        ...
        if (!StringUtils.isEmpty(passwd)) {
            ...
            parameters.setEncryptionMethod(Zip4jConstants.ENC_METHOD_STANDARD); // 加密方式 parameters.setPassword(passwd.toCharArray());
        }
        try {
